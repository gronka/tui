...
class SurferSetPhonePage extends StatefulWidget {
  final String surferId;
  const SurferSetPhonePage({required this.surferId});

  @override
  SurferSetPhonePageState createState() => SurferSetPhonePageState();
}

class SurferSetPhonePageState extends State<SurferSetPhonePage> {
  bool _canSave = false;
  String _currentValue = '';
  bool _initialLoad = true;
  String _failureMsg = '';
  final _maxLength = ValidateSurfer.phoneMaxLength;
          ...
          child: Observer(
            builder: (_) {
              ...
              return Column(
                ...
                children: <Widget>[
                  //
                  Text20('Your first name is currently ${surfer.phone}'),
                  ...
                  TextFormField(
                    ...
                    onChanged: (newValue) {
                      ...
                      if (ValidateSurfer.phone(_currentValue).isValid) {
                        setState(() {
                          _canSave = true;
                        });
                      } else {
                    ...
                    validator: (value) {
                      return ValidateSurfer.phone(_currentValue).asValidator;
                    },
                  ),
